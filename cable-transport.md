...
![Драгалевски лифт - общ изглед](http://www.planinite.info/V_pomosht_na_turista/Liftove/Snimki_Liftove/Vitosha/Web/Dragalevski-Izgled.jpg)

***Драгалевски лифт - общ изглед***

-   ***Други имена:*** Пътническа въжена линия (ПВЛ) "Драгалевци - Голи връх", лифт "Драгалевци - Заслона - Голи връх"
...
-   [**УКАЗАНИЯ КЪМ ПЪТНИЦИТЕ-1**](http://www.planinite.info/V_pomosht_na_turista/Liftove/Snimki_Liftove/Vitosha/Web/Dragalevski-Ukazaniya_1.JPG)
-   [**УКАЗАНИЯ КЪМ ПЪТНИЦИТЕ-2**](http://www.planinite.info/V_pomosht_na_turista/Liftove/Snimki_Liftove/Vitosha/Web/Dragalevski-Ukazaniya_2.JPG)
...
-   ***Връзки:***
    -   телефон: 02 / 967-11-10 (Долна лифтова станция)
-   ***Работно време:***
...
-   ***Цени:***
    ...
    -   през ски-сезона зима 2018/2019: [**Работно време и цени**](https://www.vitoshaski.com/lifts/prices)
-   ***Долна лифтова станция (над квартал "Драгалевци"):***

![Драгалевски лифт -
долната лифтова станция](http://www.planinite.info/V_pomosht_na_turista/Liftove/Snimki_Liftove/Vitosha/Web/Dragalevski-Dolna_St.jpg)

***Драгалевски лифт - долната лифтова станция***

-   ***GPS координати:*** 42 37 15.0N 023 18 13.4E
-   ***Надморска височина:*** 925 м
-   [***Сателитна снимка от Wikimapia***](http://wikimapia.org/#lang=en&lat=42.620878&lon=23.303906&z=18&m=b)
-   ***Изходен пункт до долната лифтова станция:***
    -   до долната лифтова станция отива специалeн _автобус № 93_ на градския транспорт, тръгващ от автостанция "Зоопарка" (спирка "Зоопарка", № 2764).  Поради отдалечеността на автостанция "Зоопарка", прекачването от градските автобуси (№№ 10-ТМ, 83, 88, 120) на автобус № 93 е най-удобно да се извърши в района на кръстовището до Мол "Парадайз Център" в квартал "Хладилника". Тук предстои пускането в експлоатация на трамвайна спирка "метростанция Витоша" (на трамвай № 10) и метростанция "Витоша". Прекачването от градския автобус № 111 на автобус № 93 се извършва при Околовръстния път (магазин "Фантастико"). От последната спирка "Лифта Драгалевци" (№ 2466) до Драгалевския лифт - 3-4 мин. пеша
    -   _автобус № 64:_ свързващ автостанция "Зоопарка" с Центъра по хигиена на бул. "Акад. Иван Гешов". От спирка "кв. Драгалевци" (№№ 0836/0835) до Драгалевския лифт - 0,20 ч пеша
    -   разписанието на градските и крайградските автобуси може да се види [**ТУК**](https://www.sofiatraffic.bg/)

***Междиннна лифтова станция (местност Бай Кръстю):***

![Драгалевски лифт -
междинната лифтова станция](http://www.planinite.info/V_pomosht_na_turista/Liftove/Snimki_Liftove/Vitosha/Web/Dragalevtsi_MLS.jpg)

***Драгалевски лифт - междинната лифтова станция***

-   ***GPS координати:*** 42 36 20.5N 023 17 58.9E
-   ***Надморска височина:*** 1370 м
-   [***Сателитна снимка от Wikimapia***](http://wikimapia.org/#lang=en&lat=42.605478&lon=23.299406&z=18&m=b)
-   ***Изходен пункт от междинната лифтова станция:***
    -   заслон "Кикиш" (2,830 км) - 1,00 ч
    -   хижа "Алеко" (3,480 км) - 1,15 ч
    -   хижа "Камен дел" (4,440 км) - 1,20 ч
    -   заслон "Черни връх" (7,100 км) - 2,30 ч
-   ***Горна лифтова станция (Голи връх):***

![Драгалевски лифт -
горната лифтова станция](http://www.planinite.info/V_pomosht_na_turista/Liftove/Snimki_Liftove/Vitosha/Web/Dragalevski-Gorna_St.jpg)

***Драгалевски лифт - горната лифтова станция***

-   ***GPS координати:*** 42 35 30.7N 023 17 29.4E
-   ***Надморска височина:*** 1818 м
-   [***Сателитна снимка от Wikimapia***](http://wikimapia.org/#lang=en&lat=42.591825&lon=23.291847&z=19&m=b)
-   ***Изходен пункт от горната лифтова станция:***
    -   хижа "Алеко" (800 м) - 0,15 ч
    -   заслон "Ушите" - 0,40 ч
    -   хижа "Тинтява" (през Платото и заслон "Ушите") - 1,20 ч
    -   заслон "Черни връх" (3,500 км) - 1,30 ч. Маршрутът е маркиран със 178 метални кола, боядисани в черно и жълто, което позволява безопасното му преминаване и при зимни условия
