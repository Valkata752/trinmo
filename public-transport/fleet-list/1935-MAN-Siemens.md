...
<td><b>Двуосна мотриса тип "МАН" (1935 г.)</b> <br>През 1935г., поради доказаното перфектно качество и работоспособност са внесени още 12 мотриси, този път с електрическа част от "Siemens".</td></tr>
...
Кошът е изцяло желязна конструкция (на предната доставка рамките на прозорците са от обшити с ламарина дървени елементи, по-късно сменени с желязни). Номерирани са от 81 до 92.  
