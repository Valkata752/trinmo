...
ČKD Tatra Т6А5 е чешки четириосен трамвай, чийто производство е започнало през 1991 и завършило през 1998. 150 от близо 300те произведени отиват в Прага.

В периода 2015-2020та Прага продава почти всичките си Татри Т6А5, запазват 2 за музейни експонати и останалите ги бракуват. София закупува 57 броя Т6А5 за обновяване на линия 22 и за махане на Дювазите Т4+Б4 и ГТ6. 

Доставени са на няколко доставки: 2016, 2017, 2019 и 2020та година, като 2 от тези 57 бройки идват през 2018та и 2021ва година и се ползват за резервни части. От 2019та година се пращат на основни ремонти в Трамкар (4141+4143 е първият).
...
## Конструкция
Той има три врати (първоначално вагоните са били доставяни със сгъваеми врати, а по-късно с врати на панти), стандартен висок под, отделна кабина за водача и обикновено също така тапицирани седалки, разположени или 2+1 (две от дясната страна, само един ред от лявата), или 1+1 (един ред от двете страни на вагона) - в Братислава има и вагони с разположение на седалките 1+2 (от дясната страна - един ред, от лявата страна - два реда седалки). Задната платформа на автомобила позволява ръчно управление посредством скрит контролен панел. Трамваят е оборудван с електрическо оборудване тип TV3 с тиристорно управление, магнитни спирачки и сцепки (например тип Sécheron). Произведен е в модификация за междурелсие 1000 и 1435 mm.
...
- [📷 Пълна галерия *Над ХХХ снимки*](/bg/public-transport/gallery/1995-CKD-Tatra-T6A5)
{.links-list}
