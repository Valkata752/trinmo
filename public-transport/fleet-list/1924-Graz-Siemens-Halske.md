...
<td>Кошът е изцяло дървен, рамата нитована, като впоследствие на трамвая с инв. №19, вече като работен трамвай с инв.№ 608 е добавена метална рамка от валцовани профили и странични капаци от двете страни, за да може да превозва насипни товари.</td></tr>
...
<td>Дълги години е бил работен трамвай в двора на трамвайния завод под №1, където претърпява и катастрофа, видно е на снимка в трамвайно ухо „Бъкстон “. Там е изтеглил трамвай №503 , счупил пантограф по време на пробна експлоатация.</td></tr>
  <td colspan=2 >ℹ️ предоставена от инж. Иван Николов</td></table></div>
...
<td>Същият трамвай в момента е като музеен експонат под №35 и се използва за атрактивни пътувания.</td></tr>
  <td colspan=2 >ℹ️ предоставена от инж. Иван Николов</td></table></div>
